...
public class ApplicationDbContextFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
{
    public ApplicationDbContext CreateDbContext(string[] args)
    {
        ...
        //var cs = @"Server=(localdb)\ProjectModels;Database=AutoLot_Hol_SV;Trusted_Connection=True;";
        //var cs = @"server=.,5433;Database=AutoLot_Hol_SV;User Id=sa;Password=P@ssw0rd;Encrypt=false;";
